...
async function generate(){
  draft();s.error=null;s.syncError=null;
...
async function buildSelectedWeek(){
  ...
  try{
    ...
    s.meals=d.meals||[];s.checked={};s.planId=null;s.syncError=null;s.error=null;save();
