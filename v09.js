// Mealz v0.9.3: cloud-backed household profile, dietary preferences, standardized equipment.
const DIET_GROUPS={
...
function profile(){
  ...
  clearEquipment.onclick=()=>{s.eq=[];saveProfile();profile()};
