...
export default async function handler(req,res){
  ...
  try{
    ...
    const data=await callOpenAIJson({prompt,schema:ideasSchema(ideaCount),schemaName:'mealz_meal_ideas',schemaDescription:`Exactly ${ideaCount} lightweight dinner ideas.`,timeoutMs:45000,reasoningEffort:'low',maxOutputTokens:2500,telemetry});
