...
export default async function handler(req,res){
  ...
  try{
    ...
    telemetry.finish(200,{week_start:weekStart,idea_count:ideas.length});return res.status(200).json({weekStart,ideas,ideaCount:ideas.length,defaults:{days:plans[0].cooking_days||[],householdSize:plans[0].household_size||5,equipment:plans[0].equipment||[]}});
  }catch(e){
